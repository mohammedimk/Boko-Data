...
# (network, plan_id, name, validity, cost_price) — Data plans, API Price column
DATA_PLANS = [
    ('AIRTEL', '70', '1GB (Social Bundle)', '3 Days', '295.0'),
    ('AIRTEL', '13', '500MB', '7 days', '490.0'),
    ('AIRTEL', '69', '1.5GB', '1 Day', '500.0'),
    ('AIRTEL', '66', '1.5GB', '2 Days', '599.0'),
    ('AIRTEL', '15', '1GB', '7 Days', '800.0'),
    ('AIRTEL', '17', '2GB', '30 Days', '1490.0'),
    ('AIRTEL', '52', '5GB', '7 Days', '1570.0'),
    ('AIRTEL', '18', '3GB', '30 Days', '1960.0'),
    ('AIRTEL', '22', '6GB', '7 Days', '2455.0'),
    ('AIRTEL', '19', '4GB', '30 Days', '2570.0'),
    ('AIRTEL', '20', '8GB', '30 Days', '2999.0'),
    ('AIRTEL', '21', '10GB', '30 Days', '4070.0'),
    ('GLO', '42', '200MB', '1 Day', '92.0'),
    ('GLO', '35', '500MB', '30 Days', '225.0'),
    ('GLO', '68', '1GB', '3 Days', '300.0'),
    ('GLO', '36', '1GB', '30 Days', '425.0'),
    ('GLO', '41', '1GB', '14 Days', '485.0'),
    ('GLO', '40', '2GB', '30 Days', '850.0'),
    ('GLO', '37', '3GB', '30 Days', '1300.0'),
    ('GLO', '54', '5GB', '7 Days', '1699.0'),
    ('GLO', '38', '5GB', '30 Days', '2250.0'),
    ('GLO', '39', '10GB', '30 Days', '4390.0'),
    ('GLO', '59', '20.5GB', '30 Days', '5300.0'),
    ('GLO', '58', '107GB', '30 Days', '19300.0'),
    ('MTN', '43', '110MB', '1 Day', '99.0'),
    ('MTN', '74', '230MB', '1 Day', '200.0'),
    ('MTN', '76', '500MB', '2 Days', '250.0'),
    ('MTN', '78', '1GB', '1 Day', '270.0'),
    ('MTN', '81', '1GB', '30 Days', '280.0'),
    ('MTN', '44', '500MB', '30 Days', '350.0'),
    ('MTN', '77', '1GB', '2 Days', '399.0'),
    ('MTN', '45', '1GB', '7 Days', '450.0'),
    ('MTN', '46', '1GB', '30 Days', '570.0'),
    ('MTN', '79', '2.5GB', '1 Day', '600.0'),
    ('MTN', '27', '2.5GB', '2 Days', '900.0'),
    ('MTN', '71', '2GB', '7 Days', '900.0'),
    ('MTN', '47', '2GB', '7 Days', '930.0'),
    ('MTN', '60', '4.5GB', '1 Day', '1050.0'),
    ('MTN', '48', '2GB', '30 Days', '1150.0'),
    ('MTN', '61', '4GB', '2 Days', '1175.0'),
    ('MTN', '80', '5GB', '14 Days', '1299.0'),
    ('MTN', '82', '5GB', '30 Days', '1299.0'),
    ('MTN', '49', '3GB', '30 Days', '1370.0'),
    ('MTN', '50', '5GB', '30 Days', '2050.0'),
    ('MTN', '53', '6GB', '7 Days', '2495.0'),
    ('MTN', '33', '7GB', '30 Days', '3499.0'),
    ('MTN', '55', '11GB', '7 Days', '3550.0'),
    ('MTN', '67', '10GB', '30 Days', '4800.0'),
    ('MTN', '57', '36GB', '30 Days', '10800.0'),
    ('MTN', '51', '75GB', '30 Days', '17990.0'),
]
...
CABLE_PLANS = [
    ...
    ('STARTIMES', '19', 'Basic (Dish) - 1 week', '1700'),
    ('STARTIMES', '20', 'Basic (Antenna) - 1 month', '4000'),
    ('STARTIMES', '21', 'Basic (Dish) - 1 Month', '5100'),
    ('STARTIMES', '22', 'Classic (Dish) - 1 Week', '2500'),
    ('STARTIMES', '23', 'Classic (Dish) - 1 Month', '7400'),
    ('STARTIMES', '24', 'Super (Dish) - 1 Week', '3300'),
    ('STARTIMES', '25', 'Super (Antenna) - 1 week', '3200'),
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        created_count = 0
        for network, plan_id, name, validity, cost in DATA_PLANS:
            _, created = ServicePlan.objects.update_or_create(
                service=ServicePlan.Service.DATA, network=network, provider_plan_id=plan_id,
                defaults={'name': name, 'validity': validity, 'cost_price': Decimal(cost)},
            )
            created_count += created
